...
const Untitled2 = () => {
  return <View style={_styles.vSUiXYvm}>
      <View style={_styles.TQrOkiiC}></View><Text style={_styles.qelpqVSw}>Lorem ipsum…</Text><View style={_styles.FHquZsJR}></View><ImageBackground style={_styles.IsepzJfX} source={{
