...
const Untitled6 = () => {
  return <View style={_styles.FTnwkrmi}>
      <Pressable onPress={{}} style={_styles.qPvraDXp}><View style={_styles.LoHwFHAo}></View></Pressable><Pressable onPress={{}} style={_styles.wcCIksPi}><ImageBackground style={_styles.eMZGatbm} source={{
